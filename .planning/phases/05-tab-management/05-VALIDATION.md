...
| 05-01 T2 | 01 | 1 | TAB-01, TAB-04, TAB-05 | T-05-01, T-05-02, T-05-04 | Log only ConnectionId + Hostname; snapshot-iterate CloseAllAsync | unit (STA for HostMounted sim) | `dotnet test --filter "FullyQualifiedName~TabHostManager"` | ❌ Wave 0 | ⬜ pending |
